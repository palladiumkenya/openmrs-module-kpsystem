<%
	...
	if (context.authenticatedUser) {
		...
		appMenuItems << """<a href="/${ contextPath }/kenyaemr/home.page?${ config.context ? config.context : "" }"><img src="${ ui.resourceLink("kenyaui", "images/toolbar/home.png") }" width="12" height="12" />&nbsp;&nbsp;Home</a>"""
