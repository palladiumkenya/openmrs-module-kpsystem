<% if (encounter) { %>
<button type="button" class="ke-compact" onclick="ui.navigate('${ ui.pageLink("kenyaemr", "editForm", [ encounterId: encounter.id, appId: "kenyaemr.medicalEncounter", returnUrl: ui.thisUrl() ]) }')">
