<% if (encounter) { %>
<button type="button" class="ke-compact" onclick="ui.navigate('${ ui.pageLink("kenyaemr", "editForm", [ encounterId: encounter.id, appId: currentApp != null ? currentApp.id : "kenyaemr.medicalEncounter", returnUrl: ui.thisUrl() ]) }')">
