...
public class NumberOfMaleCondomsDistributedDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select r.person_a as peer_educator,sum(p.monthly_male_condoms_distributed) as condoms_distributed from openmrs.relationship r inner join kp_etl.etl_peer_calendar p on r.person_b= p.client_id\n" +
