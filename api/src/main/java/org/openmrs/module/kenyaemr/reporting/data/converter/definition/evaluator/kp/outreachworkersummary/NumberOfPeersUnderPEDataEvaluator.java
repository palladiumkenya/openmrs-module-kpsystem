...
public class NumberOfPeersUnderPEDataEvaluator implements PersonDataEvaluator {
    ...
    public EvaluatedPersonData evaluate(PersonDataDefinition definition, EvaluationContext context) throws EvaluationException {
        ...
        String qry = "select r.person_a as peer_educator,count(p.client_id) as number_of_peers from openmrs.relationship r inner join kp_etl.etl_peer_calendar p on r.person_b= p.client_id where r.voided = 0\n" +
                "group by r.person_a;";
