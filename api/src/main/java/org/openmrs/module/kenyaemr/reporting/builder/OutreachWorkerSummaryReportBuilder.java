...
import org.openmrs.module.kenyaemr.reporting.data.converter.definition.outreachworkersummary.*;
...
public class OutreachWorkerSummaryReportBuilder extends AbstractHybridReportBuilder {
    ...
    protected PatientDataSetDefinition peDataSetDefinition() {
        ...
        dsd.addColumn("Number of HIV Self Testing Kits Distributed", new NumberOfHIVSelfTestingKitsDistributedDataDefinition(), "");
