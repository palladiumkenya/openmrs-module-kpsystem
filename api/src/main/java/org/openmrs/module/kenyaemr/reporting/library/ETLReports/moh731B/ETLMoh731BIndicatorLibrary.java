...
public class ETLMoh731BIndicatorLibrary {
    ...
    public CohortIndicator hivTestedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator hivTestedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator hivTestedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.hivTestedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator testedAtFacilityMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedAtFacilityMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedAtFacilityPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtFacilityPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator testedAtCommunityMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedAtCommunityMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedAtCommunityPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedAtCommunityPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator testedNewMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedNewMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedNewPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedNewPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator testedRepeatMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedRepeatMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator testedRepeatPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.testedRepeatPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator knownPositiveMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator knownPositiveMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositiveMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator knownPositivePwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.knownPositivePwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivedPositiveResultsMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivedPositiveResultsMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivedPositiveResultsPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivedPositiveResultsPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingCondomsMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingCondomsMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingCondomsPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingCondomsPerNeedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingCondomsPerNeedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingCondomsPerNeedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingCondomsPerNeedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingNeedlesAndSyringesMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingNeedlesAndSyringesMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingNeedlesAndSyringesPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingNeedlesAndSyringesPerNeedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPerNeedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingNeedlesAndSyringesPerNeedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPerNeedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingNeedlesAndSyringesPerNeedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingNeedlesAndSyringesPerNeedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingLubricantsMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingLubricantsMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingLubricantsPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingLubricantsPerNeedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingLubricantsPerNeedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingLubricantsPerNeedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingLubricantsPerNeedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator screenedForSTIMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForSTIMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForSTIPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForSTIPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator screenedForHCVMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHCVMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForHCVMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHCVMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForHCVPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHCVPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator screenedForHBVMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHBVMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForHBVMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHBVMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedForHBVPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedForHBVPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator positiveHBVMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.positiveHBVMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator positiveHBVMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.positiveHBVMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator positiveHBVPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.positiveHBVPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator treatedHBVMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.treatedHBVMsm(), "startDate=${startDate},endDate=${endDate}"));
    }

    public CohortIndicator treatedHBVMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.treatedHBVMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator treatedHBVPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.treatedHBVPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator negativeHBVVaccinatedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.negativeHBVVaccinatedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator negativeHBVVaccinatedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.negativeHBVVaccinatedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator negativeHBVVaccinatedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.negativeHBVVaccinatedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator screenedTBMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedTBMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedTBMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedTBMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator screenedTBPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.screenedTBPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator diagnosedTBMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.diagnosedTBMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator diagnosedTBMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.diagnosedTBMsw(), "startDate=${startDate},endDate=${endDate}"));
    }

    public CohortIndicator diagnosedTBPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.diagnosedTBPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator startedOnTBTxMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.startedOnTBTxMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator startedOnTBTxMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.startedOnTBTxMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator startedOnTBTxPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.startedOnTBTxPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator tbClientsOnHAARTMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.tbClientsOnHAARTMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator tbClientsOnHAARTMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.tbClientsOnHAARTMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator tbClientsOnHAARTPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.tbClientsOnHAARTPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator initiatedPrEPMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.initiatedPrEPMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator initiatedPrEPMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.initiatedPrEPMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator initiatedPrEPPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.initiatedPrEPPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator currentOnPrEPMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.currentOnPrEPMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator currentOnPrEPMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.currentOnPrEPMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator currentOnPrEPPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.currentOnPrEPPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator turningPositiveWhileOnPrEPMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.turningPositiveWhileOnPrEPMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator turningPositiveWhileOnPrEPMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.turningPositiveWhileOnPrEPMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator turningPositiveWhileOnPrEPPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.turningPositiveWhileOnPrEPPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator experiencingViolenceMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.experiencingViolenceMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator experiencingViolenceMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.experiencingViolenceMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator experiencingViolencePwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.experiencingViolencePwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingViolenceSupportMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingViolenceSupportMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingViolenceSupportMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingViolenceSupportMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingViolenceSupportPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingViolenceSupportPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator numberExposedMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.numberExposedMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator numberExposedMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.numberExposedMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator numberExposedPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.numberExposedPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
    ...
    public CohortIndicator receivingPEPWithin72HrsMsm() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingPEPWithin72HrsMsm(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingPEPWithin72HrsMsw() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingPEPWithin72HrsMsw(), "startDate=${startDate},endDate=${endDate}"));
    }
    public CohortIndicator receivingPEPWithin72HrsPwid() {
        return cohortIndicator("", ReportUtils.map(moh731BCohorts.receivingPEPWithin72HrsPwid(), "startDate=${startDate},endDate=${endDate}"));
    }
